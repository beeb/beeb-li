...
declare global {
	type PagefindWrapper = {
		init: () => void
		options: (PagefindIndexOptions) => unknown
		enterPlaygroundMode: () => unknown
		mergeIndex: (string, PagefindIndexOptions) => unknown
		search: (string, PagefindSearchOptions) => Promise<PagefindIndexesSearchResults>
		debouncedSearch: (string, PagefindSearchOptions?, number?) => Promise<PagefindIndexesSearchResults>
		preload: (string, PagefindSearchOptions) => unknown
